...
public class Application {
    ...
    private static ScreenProviderFactory createScreenProviderFactory(ApplicationContext ctx) {
        return new SimpleScreenProviderFactory(new App1LauncherScreenProvider("App1", "Mizuho", "fa-solid fa-desktop"),
          new App2LauncherScreenProvider("App2", "Mizuho", "fa-solid fa-desktop"),
          new App3LauncherScreenProvider("App3", "Mizuho", "fa-solid fa-desktop"),
